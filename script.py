...
print(f"client_id == 'prod_client_id_value' is {client_id == 'prod_client_id_value'}")
print(f"client_secret == 'prod_client_secret_value' is {client_secret == 'prod_client_secret_value'}")